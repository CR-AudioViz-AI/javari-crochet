// app/page.tsx — Javari Crochet
// AI-powered crochet pattern and project platform
...
export default function Home() {
  return (
    <div style={{ background: '#07080f', minHeight: '100vh', color: 'white',
      ...
      <nav data-app-chrome style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100,
                    background: 'rgba(7,7,16,0.97)', borderBottom: '1px solid rgba(255,255,255,0.06)',
                    height: 58, display: 'flex', alignItems: 'center',
                    justifyContent: 'space-between', padding: '0 24px' }}>
        <span style={{ fontWeight: 800, fontSize: 15, color: '#6366f1' }}>Javari Crochet</span>
      ...
      <footer data-app-chrome style={{ background: '#030308', borderTop: '1px solid rgba(255,255,255,0.04)',
